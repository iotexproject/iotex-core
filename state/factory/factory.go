...
type (
	...
	Factory interface {
		...
		SimulateExecutionAtHeight(context.Context, uint64, address.Address, action.Envelope, ...protocol.SimulateOption) ([]byte, *action.Receipt, error)
...
func (sf *factory) SimulateExecutionAtHeight(
	ctx context.Context,
	height uint64,
	caller address.Address,
	elp action.Envelope,
	...
	ctx, span := tracer.NewSpan(ctx, "factory.SimulateExecutionAtHeight")
	defer span.End()
