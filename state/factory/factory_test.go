...
func TestSimulateExecution(t *testing.T) {
	...
	testSimulateExecution(sf, ctx, registry, t)
}
...
func TestSTXSimulateExecution(t *testing.T) {
	...
	testSimulateExecution(sdb, ctx, registry, t)
}

func testSimulateExecution(sf Factory, ctx context.Context, registry *protocol.Registry, t *testing.T) {
	require := require.New(t)
