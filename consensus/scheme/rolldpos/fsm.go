...
func newConsensusFSM(ctx *rollDPoSCtx) (*cFSM, error) {
	...
	b := fsm.NewBuilder().
		...
		AddStates(sDKGGeneration, sRoundStart, sBlockPropose, sAcceptPropose, sAcceptProposalEndorse, sAcceptLockEndorse, sAcceptCommitEndorse).
...
func (m *cFSM) addEndorsement(
	...
	endorsementSet.AddEndorsement(en)
