...
func (ecm *EndorsedConsensusMessage) LoadProto(msg *iotextypes.ConsensusMessage, evmNetworkID uint32) error {
	switch {
	...
	case msg.GetBlockProposal() != nil:
		...
		if err := proposal.LoadProto(msg.GetBlockProposal(), evmNetworkID); err != nil {
			return err
		}
