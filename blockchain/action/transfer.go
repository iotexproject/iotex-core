...
func (tsf *Transfer) ByteStream() []byte {
	...
	stream = append(stream, tsf.srcAddr...)
	stream = append(stream, tsf.dstAddr...)
	stream = append(stream, tsf.payload...)
	stream = append(stream, tsf.srcPubkey[:]...)
