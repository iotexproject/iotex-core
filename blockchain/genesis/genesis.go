...
type (
	...
	Blockchain struct {
		...
		// GoldengateBlockHeight is the start height of storing current epoch meta and TODO
		GoldengateBlockHeight uint64 `yaml:"goldengateHeight"`
	}
