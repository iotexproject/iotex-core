...
func defaultConfig() Genesis {
	return Genesis{
		Blockchain: Blockchain{
			...
			MaxBlobsPerBlock:         6,
			MinBlocksForBlobRequests: 345600,
...
type (
	...
	Blockchain struct {
		...
		// MinBlocksForBlobRequests is the minimum number of blocks for blob requests
		MinBlocksForBlobRequests uint64 `yaml:"minBlocksForBlobRequests"`
