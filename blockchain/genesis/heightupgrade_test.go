...
func TestNewHeightChange(t *testing.T) {
	...
	require.False(cfg.IsXingu(uint64(41648760)))
	require.True(cfg.IsXingu(uint64(41648761)))
	require.False(cfg.IsXinguBeta(uint64(41648760)))
	require.True(cfg.IsXinguBeta(uint64(41648761)))
