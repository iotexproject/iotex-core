...
func (bs *blockSyncerV2) commitBlocks(blks []*peerBlock) bool {
...
func (bs *blockSyncerV2) flushInfo() (time.Time, uint64) {
	bs.mu.RLock()
	defer bs.mu.RUnlock()
...
func (bs *blockSyncerV2) requestBlock(ctx context.Context, start uint64, end uint64, repeat int) {
...
func (bs *blockSyncerV2) TargetHeight() uint64 {
	bs.mu.RLock()
	defer bs.mu.RUnlock()
...
func (bs *blockSyncerV2) ProcessBlock(ctx context.Context, peer string, blk *block.Block) error {
	if blk == nil {
...
func (bs *blockSyncerV2) ProcessSyncRequest(ctx context.Context, peer peer.AddrInfo, start uint64, end uint64) error {
	tip := bs.tipHeightHandler()
	if end > tip {
		log.L().Debug(
...
func (bs *blockSyncerV2) syncStageChecker() {
...
func (bs *blockSyncerV2) SyncStatus() (uint64, uint64, uint64, string) {
...
func (bs *blockSyncerV2) BuildReport() string {
