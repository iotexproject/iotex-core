...
func TestWeb3ServerIntegrity(t *testing.T) {
	...
	handler := api.NewHTTPHandlerWrapper(api.NewWeb3Handler(api.ServerV2Wrapper(*svr).Core(), ""))
...
func setupTestServer() (*api.ServerV2, blockchain.Blockchain, blockdao.BlockDAO, actpool.ActPool, func()) {
	cfg := newConfig()
...
func getStorageAt(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain, dao blockdao.BlockDAO, actPool actpool.ActPool) {
	...
	contractAddr, _ := api.IoAddrToEthAddrWrapper(contract)
...
func serveTestHTTP(require *require.Assertions, handler *api.HTTPHandlerWrapper, method string, param string) interface{} {
...
func gasPrice(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	result := serveTestHTTP(require, handler, "eth_gasPrice", "[]")
	actual, ok := result.(string)
	require.True(ok)
	require.Equal(api.Uint64ToHexWrapper(1000000000000), actual)
}

func chainID(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	result := serveTestHTTP(require, handler, "eth_chainId", "[]")
	actual, ok := result.(string)
	require.True(ok)
	require.Equal(api.Uint64ToHexWrapper(1), actual)
	require.Equal(api.Uint64ToHexWrapper(uint64(_evmNetworkID)), actual)
}

func blockNumber(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	result := serveTestHTTP(require, handler, "eth_blockNumber", "[]")
	actual, ok := result.(string)
	require.True(ok)
	require.Equal(api.Uint64ToHexWrapper(4), actual)
}

func getBlockByNumber(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	for _, test := range []struct {
		params   string
		expected int
...
func getBalance(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
...
func getTransactionCount(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	for _, test := range []struct {
		params   string
		expected int
		...
		actual, ok := result.(string)
		require.True(ok)
		require.Equal(api.Uint64ToHexWrapper(uint64(test.expected)), actual)
	}
}

func ethCall(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
	for _, test := range []struct {
		params   string
		expected int
...
func getNodeInfo(t *testing.T, handler *api.HTTPHandlerWrapper) {
	require := require.New(t)
...
func getBlockTransactionCountByHash(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain) {
}

func getBlockByHash(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain) {
}

func getTransactionByHash(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getLogs(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getTransactionReceipt(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getBlockTransactionCountByNumber(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getTransactionByBlockHashAndIndex(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain) {
}

func getTransactionByBlockNumberAndIndex(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func newfilter(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func newBlockFilter(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getFilterChanges(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getFilterLogs(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func getNetworkID(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func ethAccounts(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func web3Staking(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func sendRawTransaction(t *testing.T, handler *api.HTTPHandlerWrapper) {
}

func estimateGas(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain, dao blockdao.BlockDAO, actPool actpool.ActPool) {
}

func getCode(t *testing.T, handler *api.HTTPHandlerWrapper, bc blockchain.Blockchain, dao blockdao.BlockDAO, actPool actpool.ActPool) {
}
