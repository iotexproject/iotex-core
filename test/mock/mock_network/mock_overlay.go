...
func (mr *MockOverlayMockRecorder) Broadcast(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Broadcast", reflect.TypeOf((*MockOverlay)(nil).Broadcast), arg0)
}

// Tell mocks base method
func (m *MockOverlay) Tell(arg0 net.Addr, arg1 proto.Message) error {
	ret := m.ctrl.Call(m, "Tell", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockOverlayMockRecorder) Tell(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Tell", reflect.TypeOf((*MockOverlay)(nil).Tell), arg0, arg1)
}
