...
func (m *MockBlockchain) AddSubscriber(arg0 pubsub.BlockCreationSubscriber) error {
	m.ctrl.T.Helper()
...
func (m *MockBlockchain) RemoveSubscriber(arg0 pubsub.BlockCreationSubscriber) error {
	m.ctrl.T.Helper()
