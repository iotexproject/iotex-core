...
func (m *MockBlockchain) MintNewBlockWithActionIterator(actionMap map[string][]action.Action, producer *iotxaddress.Address, dkgAddress *iotxaddress.DKGAddress, seed []byte, data string) (*blockchain.Block, error) {
