...
func (m *MockServiceClient) ChainID(ctx context.Context, in *iotexapi.ChainIDRequest, opts ...grpc.CallOption) (*iotexapi.ChainIDResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ChainID", varargs...)
	ret0, _ := ret[0].(*iotexapi.ChainIDResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ChainID indicates an expected call of ChainID.
func (mr *MockServiceClientMockRecorder) ChainID(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChainID", reflect.TypeOf((*MockServiceClient)(nil).ChainID), varargs...)
}
