...
//
//	mockgen -destination=./test/mock/mock_sealed_envelope_validator/mock_sealed_envelope_validator.go -source=./action/sealedenvelopevalidator.go -package=mock_sealed_envelope_validator SealedEnvelopeValidator
//
...
func (mr *MockSealedEnvelopeValidatorMockRecorder) Validate(arg0, arg1 any) *gomock.Call {
