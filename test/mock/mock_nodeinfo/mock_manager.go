...
//
//	mockgen -destination=./test/mock/mock_nodeinfo/mock_manager.go -source=./nodeinfo/manager.go -package=mock_nodeinfo transmitter chain
//
...
func (mr *MocktransmitterMockRecorder) BroadcastOutbound(arg0, arg1 any) *gomock.Call {
...
func (mr *MocktransmitterMockRecorder) UnicastOutbound(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
