...
//
//	mockgen -destination=./test/mock/mock_actpool/mock_actpool.go github.com/iotexproject/iotex-core/v2/actpool ActPool
//
...
func (mr *MockActPoolMockRecorder) Add(ctx, act any) *gomock.Call {
...
func (mr *MockActPoolMockRecorder) AddActionEnvelopeValidators(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockActPool) AddSubscriber(sub actpool.Subscriber) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddSubscriber", sub)
}

// AddSubscriber indicates an expected call of AddSubscriber.
func (mr *MockActPoolMockRecorder) AddSubscriber(sub any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) DeleteAction(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) GetActionByHash(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) GetPendingNonce(addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) GetUnconfirmedActs(addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) ReceiveBlock(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) Start(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) Stop(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActPoolMockRecorder) Validate(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
