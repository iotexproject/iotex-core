...
//
//	mockgen -destination=./test/mock/mock_apiserver/mock_apiserver.go -source=./api/apitestserver.go -package=mock_apiserver StreamBlocksServer
//
...
func (mr *MockStreamBlocksServerMockRecorder) RecvMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamBlocksServerMockRecorder) Send(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamBlocksServerMockRecorder) SendHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamBlocksServerMockRecorder) SendMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamBlocksServerMockRecorder) SetHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamBlocksServerMockRecorder) SetTrailer(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
