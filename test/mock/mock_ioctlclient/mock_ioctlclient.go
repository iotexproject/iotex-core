...
func (m *MockClient) WriteFile(filename string, data []byte, perm os.FileMode) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) WriteFile(filename, data, perm interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteFile", reflect.TypeOf((*MockClient)(nil).WriteFile), filename, data, perm)
}
