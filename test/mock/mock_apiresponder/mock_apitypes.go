...
//
//	mockgen -destination=./test/mock/mock_apiresponder/mock_apitypes.go -source=./api/types/types.go -package=mock_apitypes APITypes
//
...
func (m *MockWeb3ResponseWriter) Write(arg0 any) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockWeb3ResponseWriterMockRecorder) Write(arg0 any) *gomock.Call {
...
func (mr *MockResponderMockRecorder) Respond(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockListenerMockRecorder) AddResponder(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockListenerMockRecorder) ReceiveBlock(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockListenerMockRecorder) RemoveResponder(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
