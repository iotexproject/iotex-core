...
func (m *MockFactory) WorkingSetAtHeight(arg0 context.Context, arg1 uint64, arg2 ...*action.SealedEnvelope) (protocol.StateManagerActionRunner, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(protocol.StateManagerActionRunner)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
