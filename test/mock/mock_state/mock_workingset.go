...
func (m *MockWorkingSet) RunActions(arg0 string, arg1 uint64, arg2 []action.Action, arg3 *uint64) (hash.Hash32B, error) {
...
func (mr *MockWorkingSetMockRecorder) RunActions(arg0, arg1, arg2 interface{}, arg3 *uint64) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RunActions", reflect.TypeOf((*MockWorkingSet)(nil).RunActions), arg0, arg1, arg2, arg3)
}
