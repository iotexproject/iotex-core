...
//
//	mockgen -destination=./test/mock/mock_blockdao/mock_blockindexer.go -package=mock_blockdao github.com/iotexproject/iotex-core/v2/blockchain/blockdao BlockIndexer
//
...
func (mr *MockBlockIndexerMockRecorder) PutBlock(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockIndexerMockRecorder) Start(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockIndexerMockRecorder) Stop(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
