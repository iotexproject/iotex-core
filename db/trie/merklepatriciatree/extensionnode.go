...
func newExtensionNodeAndPutIntoDB(
	...
	if err := mpt.putNodeIntoDB(e); err != nil {
		return nil, err
	}
	return e, nil
}
...
func (e *extensionNode) children() ([]node, error) {
...
func (e *extensionNode) delete(key keyType, offset uint8) (node, error) {
	...
	if newChild == nil {
		return nil, e.mpt.deleteNodeFromDB(e)
	}
	switch node := newChild.(type) {
	case *extensionNode:
		if err := e.mpt.deleteNodeFromDB(e); err != nil {
			return nil, err
		}
...
func (e *extensionNode) upsert(key keyType, offset uint8, value []byte) (node, error) {
	...
	lnode, err := newLeafNodeAndPutIntoDB(e.mpt, key, value)
	if err != nil {
		return nil, err
	}
	...
	return newExtensionNodeAndPutIntoDB(e.mpt, key[offset:offset+matched], bnode)
}
...
func (e *extensionNode) child() (node, error) {
	return e.mpt.loadNodeFromDB(e.childHash)
}
...
func (e *extensionNode) updatePath(path []byte) (*extensionNode, error) {
	...
	e.path = path
	e.ser = nil
	if err := e.mpt.putNodeIntoDB(e); err != nil {
		return nil, err
	}
	return e, nil
}
