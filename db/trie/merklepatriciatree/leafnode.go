...
func newLeafNodeAndPutIntoDB(
	...
	if err := mpt.putNodeIntoDB(l); err != nil {
		return nil, err
	}
	return l, nil
}
...
func (l *leafNode) children() ([]node, error) {
...
func (l *leafNode) delete(key keyType, offset uint8) (node, error) {
	...
	if err := l.mpt.deleteNodeFromDB(l); err != nil {
		return nil, err
	}
	return nil, nil
}
...
func (l *leafNode) upsert(key keyType, offset uint8, value []byte) (node, error) {
	...
	newl, err := newLeafNodeAndPutIntoDB(l.mpt, key, value)
	if err != nil {
		return nil, err
	}
	...
	return newExtensionNodeAndPutIntoDB(l.mpt, l.key[offset:offset+matched], bnode)
}
...
func (l *leafNode) updateValue(value []byte) (*leafNode, error) {
	...
	l.value = value
	l.ser = nil
	if err := l.mpt.putNodeIntoDB(l); err != nil {
		return nil, err
	}
