...
type ActionIndex struct {
	...
	BlkHash              []byte   `protobuf:"bytes,2,opt,name=blkHash,proto3" json:"blkHash,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ActionIndex) GetBlkHash() []byte {
	if m != nil {
		return m.BlkHash
	}
	return nil
...
var fileDescriptor_f750e0f7889345b5 = []byte{
	...
	0x28, 0xb9, 0x72, 0x71, 0x43, 0xf4, 0xc2, 0x8d, 0x4f, 0xca, 0xc9, 0xf6, 0x48, 0xcd, 0x4c, 0xcf,
	0x28, 0x01, 0x1b, 0xcf, 0x12, 0x84, 0x10, 0x10, 0x92, 0xe0, 0x62, 0x07, 0x71, 0x10, 0x36, 0xc0,
	0xb8, 0x49, 0x6c, 0x60, 0x47, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xff, 0x71, 0xf4, 0x1f,
	0xc3, 0x00, 0x00, 0x00,
}
