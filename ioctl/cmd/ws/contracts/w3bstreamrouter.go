...
func (_W3bstreamRouter *W3bstreamRouterTransactor) Route(opts *bind.TransactOpts, _projectId *big.Int, _proverId *big.Int, _clientId string, _data []byte) (*types.Transaction, error) {
	return _W3bstreamRouter.contract.Transact(opts, "route", _projectId, _proverId, _clientId, _data)
}

// Route is a paid mutator transaction binding the contract method 0xc6675469.
//
// Solidity: function route(uint256 _projectId, uint256 _proverId, string _clientId, bytes _data) returns()
func (_W3bstreamRouter *W3bstreamRouterSession) Route(_projectId *big.Int, _proverId *big.Int, _clientId string, _data []byte) (*types.Transaction, error) {
	return _W3bstreamRouter.Contract.Route(&_W3bstreamRouter.TransactOpts, _projectId, _proverId, _clientId, _data)
}

// Route is a paid mutator transaction binding the contract method 0xc6675469.
//
// Solidity: function route(uint256 _projectId, uint256 _proverId, string _clientId, bytes _data) returns()
func (_W3bstreamRouter *W3bstreamRouterTransactorSession) Route(_projectId *big.Int, _proverId *big.Int, _clientId string, _data []byte) (*types.Transaction, error) {
	return _W3bstreamRouter.Contract.Route(&_W3bstreamRouter.TransactOpts, _projectId, _proverId, _clientId, _data)
}
