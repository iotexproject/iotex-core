...
// stake2ChangeCmd represents the stake2 change command
...
func init() {
	registerWriteCommand(stake2ChangeCmd)
}
...
func stake2Change(args []string) error {
	...
	s2c, err := action.NewChangeCandidate(candidateName, bucketIndex, data)
	if err != nil {
