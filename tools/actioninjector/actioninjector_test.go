...
func TestActionInjector(t *testing.T) {
	...
	injectByAps(wg, aps, counter, transferGas, transferGasPrice, transferPayload, voteGas, voteGasPrice, contract, executionAmount, executionGas, executionGasPrice, executionData, client, admins, delegates, d, retryNum, retryInterval)
	wg.Wait()
	...
	executionNum := 1
	interval := 1
	injectByInterval(transferNum, transferGas, transferGasPrice, transferPayload, voteNum, voteGas, voteGasPrice, executionNum, contract, executionAmount, executionGas, executionGasPrice, executionData, interval, counter, client, admins, delegates, retryNum, retryInterval)
