...
func GetActionByActionHash(api *api.GRPCServer, actHash hash.Hash256) (*iotexapi.ActionInfo, error) {
...
func GetReceiptByAction(api *api.GRPCServer, actHash hash.Hash256) (*iotextypes.Receipt, error) {
