...
func init() {
	...
	flag.IntVar(&rawInjectCfg.randAccounts, "rand-accounts", 30, "number of accounst to use")
	...
	flag.StringVar(&rawInjectCfg.loadTokenAmount, "load-token-amount", "10000000000000000000", "init load how much token to inject accounts")
