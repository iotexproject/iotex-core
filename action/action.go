...
func (elp *Envelope) Proto() *iproto.ActionCore {
	...
	switch act := act.(type) {
	case *Transfer:
		actCore.Action = &iproto.ActionCore_Transfer{Transfer: act.Proto()}
	case *Vote:
		actCore.Action = &iproto.ActionCore_Vote{Vote: act.Proto()}
	case *Execution:
		actCore.Action = &iproto.ActionCore_Execution{Execution: act.Proto()}
	case *PutBlock:
		actCore.Action = &iproto.ActionCore_PutBlock{PutBlock: act.Proto()}
	case *StartSubChain:
		actCore.Action = &iproto.ActionCore_StartSubChain{StartSubChain: act.Proto()}
	case *StopSubChain:
		actCore.Action = &iproto.ActionCore_StopSubChain{StopSubChain: act.Proto()}
	case *CreateDeposit:
		actCore.Action = &iproto.ActionCore_CreateDeposit{CreateDeposit: act.Proto()}
	case *SettleDeposit:
		actCore.Action = &iproto.ActionCore_SettleDeposit{SettleDeposit: act.Proto()}
	case *GrantReward:
		actCore.Action = &iproto.ActionCore_GrantReward{GrantReward: act.Proto()}
	case *SetReward:
		actCore.Action = &iproto.ActionCore_SetReward{SetReward: act.Proto()}
	case *ClaimFromRewardingFund:
		actCore.Action = &iproto.ActionCore_ClaimFromRewardingFund{ClaimFromRewardingFund: act.Proto()}
	case *DepositToRewardingFund:
		actCore.Action = &iproto.ActionCore_DepositToRewardingFund{DepositToRewardingFund: act.Proto()}
	default:
