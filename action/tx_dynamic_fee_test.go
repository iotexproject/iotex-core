...
func TestDynamicFeeTxSelf(t *testing.T) {
	...
	r.NoError(err)
	r.Equal("1002180328013201343a01354a6c0a2830303030303030303030303030303030303030303030303030303030303030303030303030303031124030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303030303032e00103", hex.EncodeToString(b))
