...
func TestActionProtoAndVerify(t *testing.T) {
	...
	t.Run("empty public key", func(t *testing.T) {
		...
		require.EqualError(selp.VerifyPubKey(), "empty public key")
	})
	t.Run("gas limit too low", func(t *testing.T) {
		...
		require.Equal(ErrIntrinsicGas, errors.Cause(selp.CheckGas()))
	})
	t.Run("invalid signature", func(t *testing.T) {
		...
		require.Equal(ErrInvalidSender, errors.Cause(selp.VerifyPubKey()))
	})
}
