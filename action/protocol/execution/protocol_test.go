...
func TestERC20(t *testing.T) {
	sct := &smartContractTest{
		prepare: map[string]*big.Int{
			ta.Addrinfo["producer"].RawAddress: blockchain.Gen.TotalSupply,
			ta.Addrinfo["alfa"].RawAddress:     big.NewInt(0),
			ta.Addrinfo["bravo"].RawAddress:    big.NewInt(0),
		},
		deploy: execCfg{
			...
			executor:         ta.Addrinfo["producer"].RawAddress,
			privateKey:       ta.Addrinfo["producer"].PrivateKey,
			amount:           0,
		...
		executions: []execCfg{
			...
			func() execCfg {
				...
				data = append(data, value[:]...)
				return execCfg{
					executor:         ta.Addrinfo["alfa"].RawAddress,
					privateKey:       ta.Addrinfo["alfa"].PrivateKey,
					codeHex:          hex.EncodeToString(data),
					amount:           0,
					gasLimit:         uint64(10000000),
					gasPrice:         0,
...
func TestDelegateERC20(t *testing.T) {
	sct := &smartContractTest{
		prepare: map[string]*big.Int{ta.Addrinfo["alfa"].RawAddress: big.NewInt(9876543210)},
		deploy: execCfg{
			executor:            ta.Addrinfo["alfa"].RawAddress,
			privateKey:          ta.Addrinfo["alfa"].PrivateKey,
