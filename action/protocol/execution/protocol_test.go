...
func TestProtocol_Handle(t *testing.T) {
	testEVM := func(t *testing.T) {
		...
		execution, err := action.NewExecution(
			testaddress.Addrinfo["producer"].String(), action.EmptyAddress, 1, big.NewInt(0), uint64(100000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution, err = action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contractAddr, 2, big.NewInt(0), uint64(120000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution, err = action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contractAddr, 3, big.NewInt(0), uint64(120000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution1, err := action.NewExecution(
			testaddress.Addrinfo["producer"].String(), action.EmptyAddress, 4, big.NewInt(0), uint64(100000), big.NewInt(10), data)
		require.NoError(err)
		bd = &action.EnvelopeBuilder{}
	...
	testRollDice := func(t *testing.T) {
		...
		execution, err := action.NewExecution(
			testaddress.Addrinfo["producer"].String(), action.EmptyAddress, 1, big.NewInt(0), uint64(1000000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution, err = action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contractAddr, 2, big.NewInt(500000000), uint64(120000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution, err = action.NewExecution(
			testaddress.Addrinfo["bravo"].String(), contractAddr, 1, big.NewInt(0), uint64(120000), big.NewInt(10), data)
		require.NoError(err)
	...
	testERC20 := func(t *testing.T) {
		...
		execution, err := action.NewExecution(
			testaddress.Addrinfo["producer"].String(), action.EmptyAddress, 1, big.NewInt(0), uint64(5000000), big.NewInt(0), data)
		require.NoError(err)
		...
		execution, err = action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contract, 2, big.NewInt(0), uint64(1000000), big.NewInt(0), data)
		require.NoError(err)
		...
		ex2, err := action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contract, 3, big.NewInt(0), uint64(1000000), big.NewInt(0), data)
		require.NoError(err)
		...
		ex3, err := action.NewExecution(
			testaddress.Addrinfo["alfa"].String(), contract, 1, big.NewInt(0), uint64(10000000), big.NewInt(0), data)
		require.NoError(err)
		...
		log.L().Warn("TestER", zap.Binary("v", data[:]))
		execution, err = action.NewExecution(
			testaddress.Addrinfo["producer"].String(), contract, 4, big.NewInt(0), uint64(10000000), big.NewInt(0), data)
		require.NoError(err)
		bd = &action.EnvelopeBuilder{}
		elp = bd.SetAction(execution).
			SetDestinationAddress(contract).
