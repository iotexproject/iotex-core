...
func (stateDB *StateDBAdapter) GetBalance(evmAddr common.Address) *uint256.Int {
	...
	return toUint256(state.Balance)
}
...
// Selfdestruct6780 per EIP-6780
func (stateDB *StateDBAdapter) Selfdestruct6780(common.Address) {
