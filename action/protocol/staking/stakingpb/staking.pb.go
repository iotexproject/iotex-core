...
type Candidate struct {
	...
	Pubkey             string `protobuf:"bytes,9,opt,name=pubkey,proto3" json:"pubkey,omitempty"`                       // BLS public key in hex format
}
...
func (x *Candidate) GetPubkey() string {
	if x != nil {
		return x.Pubkey
	}
	return ""
...
var file_action_protocol_staking_stakingpb_staking_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x75, 0x62,
	...
	0x78, 0x70, 0x69, 0x72, 0x65, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x46, 0x5a, 0x44, 0x67,
