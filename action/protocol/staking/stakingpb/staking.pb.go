...
type Candidate struct {
	...
	// IIP-59: delegate has opted into protocol-native voter reward distribution.
	// Mutated by SetVoterRewardOptIn action; effect delayed 1 epoch via the
	// PutPollResult snapshot (rewarding reads the frozen value, not this live one).
...
// IIP-59: per-voter aggregated weight entry inside a CandidatePollSnapshot.
// `voter` is the 20-byte address bytes; `weight` is the big-endian encoding
// of a big.Int. Entries within a snapshot are sorted ascending by `voter`.
...
// epoch, so mid-epoch changes to the DelegateProfile contract or to the
// candidate's opt-in flag do not retroactively re-split the current epoch's
// rewards.
type CandidatePollSnapshot struct {
	...
	// time. Basis points in [0, 10000]. Both zero when `registered` is false.
	...
	// non-empty bytes at snapshot time. False ⇒ the commission rates above
	// are meaningless; rewarding MUST fall back to the legacy path.
	Registered bool `protobuf:"varint,3,opt,name=registered,proto3" json:"registered,omitempty"`
	// `staking.Candidate.VoterRewardOnchainOptIn` at snapshot time. The
	// delayed-1-epoch semantics live here.
	VoterRewardOnchainOptIn bool `protobuf:"varint,4,opt,name=voterRewardOnchainOptIn,proto3" json:"voterRewardOnchainOptIn,omitempty"`
	// Per-voter aggregated weight entries, sorted ascending by `voter` bytes.
	// Empty in the initial PR that introduces this message; the voter-weight
	// source is a separate follow-up. An empty list means the downstream
	// reward split degenerates to full-amount-to-delegate.
	Entries []*VoterWeightEntry `protobuf:"bytes,5,rep,name=entries,proto3" json:"entries,omitempty"`
	// Cached deterministic metadata used to keep continuation work bounded by
	// the configured voter window instead of rescanning all entries.
	...
	LastWeightedIndex  uint32 `protobuf:"varint,8,opt,name=lastWeightedIndex,proto3" json:"lastWeightedIndex,omitempty"`
	HasWeightedEntries bool   `protobuf:"varint,9,opt,name=hasWeightedEntries,proto3" json:"hasWeightedEntries,omitempty"`
}
...
func (x *CandidatePollSnapshot) GetVoterRewardOnchainOptIn() bool {
	if x != nil {
		return x.VoterRewardOnchainOptIn
	}
	return false
...
func (x *CandidatePollSnapshot) GetEntries() []*VoterWeightEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *CandidatePollSnapshot) GetLastWeightedIndex() uint32 {
	if x != nil {
...
func (x *CandidatePollSnapshot) GetHasWeightedEntries() bool {
	if x != nil {
...
var file_staking_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x9d, 0x03, 0x0a, 0x09, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12,
	...
	0x6e, 0x22, 0x42, 0x0a, 0x0a, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12,
	0x34, 0x0a, 0x0a, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x70, 0x62, 0x2e,
	0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x0a, 0x63, 0x61, 0x6e, 0x64, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x73, 0x22, 0x3b, 0x0a, 0x0b, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x6d,
	...
	,
	...
	,
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x73,
	0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_staking_proto_goTypes = []any{
	...
	(*VoterWeightEntry)(nil),      // 10: stakingpb.VoterWeightEntry
	(*CandidatePollSnapshot)(nil), // 11: stakingpb.CandidatePollSnapshot
...
var file_staking_proto_depIdxs = []int32{
	...
	10, // 4: stakingpb.CandidatePollSnapshot.entries:type_name -> stakingpb.VoterWeightEntry
