...
type Candidate struct {
	...
	// IIP-59: latest user-set voter reward commission rate (basis points, 0-10000).
	// 0 = legacy (no auto-distribution).
	CommissionRate uint64 `protobuf:"varint,11,opt,name=commissionRate,proto3" json:"commissionRate,omitempty"`
}
...
// IIP-59: per-candidate frozen voter weights, written once per epoch by
// PutPollResult and read by GrantEpochReward at distribution time. Stored
// at one state key per candidate (key = _voterWeightSnap || candID) so
// distribution can read the full voter list with a single state lookup.
// Entries are sorted by voter address — the serialization is deterministic
// so SnapshotVoterWeights can do an unchanged-blob-skip via raw bytes
// equality.
...
type VoterWeightEntry struct {
	...
	// 20-byte voter address bytes.
	Voter []byte `protobuf:"bytes,1,opt,name=voter,proto3" json:"voter,omitempty"`
	// Weighted votes as bytes (big-endian magnitude of a big.Int — same
	// encoding as iotextypes.Candidate.votes).
...
var file_staking_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x8b, 0x03, 0x0a, 0x09, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x12,
	...
	,
	...
	0x41, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x41, 0x74,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64,
	0x41, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x75, 0x6e, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x64, 0x41, 0x74,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x75, 0x6e, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x64,
	0x41, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x05, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x74, 0x69, 0x6d, 0x65,
	...
	0x63, 0x6f, 0x6c, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x73, 0x74, 0x61, 0x6b,
