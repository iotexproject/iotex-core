...
func TestEncodeVoteBucketListToEth(t *testing.T) {
	...
	data, err := stakingComm.EncodeVoteBucketListToEth(_bucketsMethod.Outputs, &iotextypes.VoteBucketList{
		Buckets: buckets,
	})
...
func TestEncodeVoteBucketListToEthErrorCandidateAddress(t *testing.T) {
	...
	_, err := stakingComm.EncodeVoteBucketListToEth(_bucketsMethod.Outputs, &iotextypes.VoteBucketList{
		Buckets: buckets,
	})

	r.EqualError(err, stakingComm.ErrInvalidMsg)
}
