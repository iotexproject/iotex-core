...
const _compositeBucketsByIndexesInterfaceABI = `[
	{
		...
		"name": "compositeBucketsByIndexesV3",
		"outputs": [
			{
				"components": [
					{
...
func init() {
	_compositeBucketsByIndexesMethod = abiutil.MustLoadMethod(_compositeBucketsByIndexesInterfaceABI, "compositeBucketsByIndexesV3")
}
