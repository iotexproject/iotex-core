...
type BlockProducerRewardType int32

const (
	BlockProducerRewardType_Block BlockProducerRewardType = 0
	BlockProducerRewardType_Epoch BlockProducerRewardType = 1
)

var BlockProducerRewardType_name = map[int32]string{
	0: "Block",
	1: "Epoch",
}
var BlockProducerRewardType_value = map[string]int32{
	"Block": 0,
	"Epoch": 1,
}

func (x BlockProducerRewardType) String() string {
	return proto.EnumName(BlockProducerRewardType_name, int32(x))
}
func (BlockProducerRewardType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{0}
}
...
func (*VotePb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{1}
}
...
func (*ExecutionPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{2}
}
...
func (*StartSubChainPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{3}
}
...
func (*StopSubChainPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{4}
}
...
func (*MerkleRoot) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{5}
}
...
func (*PutBlockPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{6}
}
...
func (*CreateDepositPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{7}
}
...
func (*SettleDepositPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{8}
}
...
func (*CreatePlumChainPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{9}
}
...
func (*TerminatePlumChainPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{10}
}
...
func (*PlumPutBlockPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{11}
}
...
func (*PlumCreateDepositPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{12}
}
...
func (*PlumStartExitPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{13}
}
...
func (*PlumChallengeExit) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{14}
}
...
func (*PlumResponseChallengeExit) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{15}
}
...
func (*PlumFinalizeExit) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{16}
}
...
func (*PlumSettleDepositPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{17}
}
...
func (*PlumTransferPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{18}
}
...
type ActionPb struct {
	...
	//	*ActionPb_SetBlockProducerReward
	//	*ActionPb_GrantBlockProducerReward
...
func (*ActionPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{19}
}
...
type ActionPb_SetBlockProducerReward struct {
	SetBlockProducerReward *SetBlockProducerReward `protobuf:"bytes,32,opt,name=setBlockProducerReward,proto3,oneof"`
}

type ActionPb_GrantBlockProducerReward struct {
	GrantBlockProducerReward *GrantBlockProducerReward `protobuf:"bytes,33,opt,name=grantBlockProducerReward,proto3,oneof"`
}
...
func (*ActionPb_SetBlockProducerReward) isActionPb_Action() {}

func (*ActionPb_GrantBlockProducerReward) isActionPb_Action() {}
...
func (m *ActionPb) GetSetBlockProducerReward() *SetBlockProducerReward {
	if x, ok := m.GetAction().(*ActionPb_SetBlockProducerReward); ok {
		return x.SetBlockProducerReward
	}
	return nil
}

func (m *ActionPb) GetGrantBlockProducerReward() *GrantBlockProducerReward {
	if x, ok := m.GetAction().(*ActionPb_GrantBlockProducerReward); ok {
		return x.GrantBlockProducerReward
	}
	return nil
}
...
func (*ActionPb) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ActionPb_OneofMarshaler, _ActionPb_OneofUnmarshaler, _ActionPb_OneofSizer, []interface{}{
		...
		(*ActionPb_SetBlockProducerReward)(nil),
		(*ActionPb_GrantBlockProducerReward)(nil),
	}
}
...
func _ActionPb_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ActionPb_SetBlockProducerReward:
		b.EncodeVarint(32<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SetBlockProducerReward); err != nil {
			return err
		}
	case *ActionPb_GrantBlockProducerReward:
		b.EncodeVarint(33<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.GrantBlockProducerReward); err != nil {
			return err
		}
	case nil:
	default:
...
func _ActionPb_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 31: // action.claimFromProducerFund
		...
		return true, err
	case 32: // action.setBlockProducerReward
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SetBlockProducerReward)
		err := b.DecodeMessage(msg)
		m.Action = &ActionPb_SetBlockProducerReward{msg}
		return true, err
	case 33: // action.grantBlockProducerReward
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(GrantBlockProducerReward)
		err := b.DecodeMessage(msg)
		m.Action = &ActionPb_GrantBlockProducerReward{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ActionPb_OneofSizer(msg proto.Message) (n int) {
	...
	case *ActionPb_ClaimFromProducerFund:
		...
		n += s
	case *ActionPb_SetBlockProducerReward:
		s := proto.Size(x.SetBlockProducerReward)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *ActionPb_GrantBlockProducerReward:
		s := proto.Size(x.GrantBlockProducerReward)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*ReceiptPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{20}
}
...
func (*LogPb) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{21}
}
...
func (*DonateToProducerFund) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{22}
}
...
func (*ClaimFromProducerFund) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{23}
}
...
type SetBlockProducerReward struct {
	Amount               []byte                  `protobuf:"bytes,1,opt,name=amount,proto3" json:"amount,omitempty"`
	Data                 []byte                  `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Type                 BlockProducerRewardType `protobuf:"varint,3,opt,name=type,proto3,enum=iproto.BlockProducerRewardType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *SetBlockProducerReward) Reset()         { *m = SetBlockProducerReward{} }
func (m *SetBlockProducerReward) String() string { return proto.CompactTextString(m) }
func (*SetBlockProducerReward) ProtoMessage()    {}
func (*SetBlockProducerReward) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{24}
}
func (m *SetBlockProducerReward) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetBlockProducerReward.Unmarshal(m, b)
}
func (m *SetBlockProducerReward) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetBlockProducerReward.Marshal(b, m, deterministic)
}
func (dst *SetBlockProducerReward) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetBlockProducerReward.Merge(dst, src)
}
func (m *SetBlockProducerReward) XXX_Size() int {
	return xxx_messageInfo_SetBlockProducerReward.Size(m)
}
func (m *SetBlockProducerReward) XXX_DiscardUnknown() {
	xxx_messageInfo_SetBlockProducerReward.DiscardUnknown(m)
}

var xxx_messageInfo_SetBlockProducerReward proto.InternalMessageInfo

func (m *SetBlockProducerReward) GetAmount() []byte {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *SetBlockProducerReward) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *SetBlockProducerReward) GetType() BlockProducerRewardType {
	if m != nil {
		return m.Type
	}
	return BlockProducerRewardType_Block
}

type GrantBlockProducerReward struct {
	Type                 BlockProducerRewardType `protobuf:"varint,1,opt,name=type,proto3,enum=iproto.BlockProducerRewardType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *GrantBlockProducerReward) Reset()         { *m = GrantBlockProducerReward{} }
func (m *GrantBlockProducerReward) String() string { return proto.CompactTextString(m) }
func (*GrantBlockProducerReward) ProtoMessage()    {}
func (*GrantBlockProducerReward) Descriptor() ([]byte, []int) {
	return fileDescriptor_action_4422ded079c21007, []int{25}
}
func (m *GrantBlockProducerReward) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GrantBlockProducerReward.Unmarshal(m, b)
}
func (m *GrantBlockProducerReward) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GrantBlockProducerReward.Marshal(b, m, deterministic)
}
func (dst *GrantBlockProducerReward) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GrantBlockProducerReward.Merge(dst, src)
}
func (m *GrantBlockProducerReward) XXX_Size() int {
	return xxx_messageInfo_GrantBlockProducerReward.Size(m)
}
func (m *GrantBlockProducerReward) XXX_DiscardUnknown() {
	xxx_messageInfo_GrantBlockProducerReward.DiscardUnknown(m)
}

var xxx_messageInfo_GrantBlockProducerReward proto.InternalMessageInfo

func (m *GrantBlockProducerReward) GetType() BlockProducerRewardType {
	if m != nil {
		return m.Type
	}
	return BlockProducerRewardType_Block
...
func init() {
	...
	proto.RegisterType((*SetBlockProducerReward)(nil), "iproto.SetBlockProducerReward")
	proto.RegisterType((*GrantBlockProducerReward)(nil), "iproto.GrantBlockProducerReward")
	proto.RegisterEnum("iproto.BlockProducerRewardType", BlockProducerRewardType_name, BlockProducerRewardType_value)
}

func init() { proto.RegisterFile("action.proto", fileDescriptor_action_4422ded079c21007) }

var fileDescriptor_action_4422ded079c21007 = []byte{
	...
	,
}
