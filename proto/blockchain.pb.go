...
type TxPb struct {
	...
	SenderPubKey []byte `protobuf:"bytes,35,opt,name=senderPubKey,proto3" json:"senderPubKey,omitempty"`
	Signature    []byte `protobuf:"bytes,36,opt,name=signature,proto3" json:"signature,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
