...
type BlockMeta struct {
	...
	TxRoot               string   `protobuf:"bytes,8,opt,name=txRoot,proto3" json:"txRoot,omitempty"`
	ReceiptRoot          string   `protobuf:"bytes,9,opt,name=receiptRoot,proto3" json:"receiptRoot,omitempty"`
	DeltaStateDigest     string   `protobuf:"bytes,10,opt,name=deltaStateDigest,proto3" json:"deltaStateDigest,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
