...
func TestSGDRegistry(t *testing.T) {
	...
	nonce := uint64(1)
	exec, err := action.SignedExecution(action.EmptyAddress, _execPriKey, nonce, big.NewInt(0), 10000000, big.NewInt(9000000000000), data)
	r.NoError(err)
	...
	t.Run("registerContract", func(t *testing.T) {
		...
		exec, err = action.SignedExecution(contractAddress, _execPriKey, nonce+1, big.NewInt(0), 10000000, big.NewInt(9000000000000), data)
		r.NoError(err)
		r.NoError(ap.Add(context.Background(), exec))
		blk, err = bc.MintNewBlock(fixedTime)
		r.NoError(err)
	...
	t.Run("approveContract", func(t *testing.T) {
		...
		exec, err = action.SignedExecution(contractAddress, _execPriKey, nonce+2, big.NewInt(0), 10000000, big.NewInt(9000000000000), data)
		r.NoError(err)
		r.NoError(ap.Add(context.Background(), exec))
		blk, err = bc.MintNewBlock(fixedTime)
		r.NoError(err)
	...
	t.Run("disapproveContract", func(t *testing.T) {
		...
		exec, err = action.SignedExecution(contractAddress, _execPriKey, nonce+3, big.NewInt(0), 10000000, big.NewInt(9000000000000), data)
		r.NoError(err)
		r.NoError(ap.Add(context.Background(), exec))
		blk, err = bc.MintNewBlock(fixedTime)
		r.NoError(err)
	...
	t.Run("removeContract", func(t *testing.T) {
		...
		exec, err = action.SignedExecution(contractAddress, _execPriKey, nonce+4, big.NewInt(0), 10000000, big.NewInt(9000000000000), data)
		r.NoError(err)
		r.NoError(ap.Add(context.Background(), exec))
		blk, err = bc.MintNewBlock(fixedTime)
		r.NoError(err)
