...
//
//	mockgen -destination=./api/mock_coreservicewithheight.go -source=./api/coreservice_with_height.go -package=api CoreServiceWithHeight
//
...
func (mr *MockCoreServiceReaderWithHeightMockRecorder) Account(arg0 any) *gomock.Call {
...
func (mr *MockCoreServiceReaderWithHeightMockRecorder) ReadContract(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
