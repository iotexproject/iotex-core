...
type Config struct {
	...
	// WebsocketMaxRateMessages is the maximum number of messages per second per client.
	WebsocketMaxRateMessages int `yaml:"websocketMaxRateMessages"`
}
