...
func TestSendRawTransaction(t *testing.T) {
	...
	testData := []struct {
		...
		{
			"transfer",
			[]interface{}{"f8600180830186a09412745fec82b585f239c01090882eb40702c32b04808025a0b0e1aab5b64d744ae01fc9f1c3e9919844a799e90c23129d611f7efe6aec8a29a0195e28d22d9b280e00d501ff63525bb76f5c87b8646c89d5d9c5485edcb1b498"},
			"0x778fd5a054e74e9055bf68ef5f9d559fa306e8ba7dee608d0a3624cca0b63b3e",
		},
		{
			"stakeCreate",
			[]interface{}{""},
			"0x0a0125ddd7924a060e5828680dc8d8082a2659823ff7bd1679d480578fd504d4",
		},
	}
	for _, v := range testData {
		t.Run(v.testName, func(t *testing.T) {
			res, err := svr.web3Server.sendRawTransaction(v.data)
			require.NoError(err)
			require.Equal(v.hash, res)
		})
	}
}
