...
// FromProtoBuf converts protobuf to endorsement set
func (s *Set) FromProtoBuf(sPb *iproto.EndorsementSet) error {
...
// ToProtoBuf convert the endorsement set to protobuf
func (s *Set) ToProtoBuf() *iproto.EndorsementSet {
