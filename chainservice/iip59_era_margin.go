...
// validateIIP59EraMargin rejects an activation height that would turn IIP-59
// on too late to freeze the first era it settles.
//
...
// checkIIP59EraMargin resolves the registered rolldpos protocol and applies
// the margin rule.
//
...
func checkIIP59EraMargin(g genesis.Genesis, reg *protocol.Registry) error {
	return validateIIP59EraMargin(g, rolldpos.FindProtocol(reg))
}
