...
func New(
	...
	if cfg.Chain.EnableStakingProtocol {
		stakingProtocol, err = staking.NewProtocol(rewarding.DepositGas, cfg.Genesis.Staking, candBucketsIndexer, cfg.Chain.EnableArchiveMode && !cfg.Chain.EnableTrielessStateDB, cfg.Genesis.GreenlandBlockHeight)
		if err != nil {
			return nil, err
		}
