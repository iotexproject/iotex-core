...
type GenesisBlockchain struct {
	...
	ActiveProtocols       []string `protobuf:"bytes,9,rep,name=activeProtocols,proto3" json:"activeProtocols,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}
...
func (m *GenesisBlockchain) GetActiveProtocols() []string {
	if m != nil {
		return m.ActiveProtocols
	}
	return nil
}
...
var fileDescriptor_8090b9f9a91af920 = []byte{
	...
	,
}
