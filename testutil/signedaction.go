...
func SignedTransfer(senderAddr string, recipientAddr string, senderPriKey *ecdsa.PrivateKey, nonce uint64, amount *big.Int, payload []byte, gasLimit uint64, gasPrice *big.Int) (action.SealedEnvelope, error) {
...
func SignedVote(voterAddr string, voteeAddr string, voterPriKey *ecdsa.PrivateKey, nonce uint64, gasLimit uint64, gasPrice *big.Int) (action.SealedEnvelope, error) {
...
func SignedExecution(executorAddr string, contractAddr string, executorPriKey *ecdsa.PrivateKey, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte) (action.SealedEnvelope, error) {
